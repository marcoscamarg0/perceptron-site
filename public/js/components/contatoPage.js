    ...
    el.innerHTML = `
        ...
        <div class="contato-content">
            <div class="contato-info">
                ...
                <div class="contato-info-list">
                    <div class="contato-info-item">
                        ...
                        <div>
                            <div class="contato-info-label">Escritório</div>
                            <div class="contato-info-value">SHIS QI 01, Conjunto 08, Bloco D<br>Lago Sul, Brasília — DF, 71605-085</div>
                        </div>
                    </div>
                    <div class="contato-info-item">
                        <div class="contato-info-icon">
                        ...
                        <div>
                            ...
                            <div class="contato-info-value">+55 (61) 3300-4400<br>+55 (61) 99999-4400</div>
                        </div>
                    </div>
                    <div class="contato-info-item">
                        <div class="contato-info-icon">
                        ...
                        <div>
                            ...
                            <div class="contato-info-value">contato@perceptron.com.br<br>atendimento@perceptron.com.br</div>
                        </div>
                    </div>
                    <div class="contato-info-item">
                        <div class="contato-info-icon">
            ...
            <div class="contato-form">
                ...
                <p class="contato-form-sub">Lorem ipsum dolor sit amet consectetur adipiscing elit. Respondemos em até 4 horas úteis.</p>

                <form id="contatoForm" onsubmit="submitContato(event)">
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">Nome Completo *</label>
                            <input class="form-input" type="text" placeholder="Lorem Ipsum da Silva" required />
                        </div>
                        <div class="form-group">
                            <label class="form-label">Empresa</label>
                            <input class="form-input" type="text" placeholder="Lorem Ipsum Ltda." />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">E-mail *</label>
                            <input class="form-input" type="email" placeholder="lorem@empresa.com.br" required />
                        </div>
                        <div class="form-group">
                            <label class="form-label">Telefone</label>
                            <input class="form-input" type="tel" placeholder="(61) 99999-0000" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-textarea" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Descreva sua necessidade..." required></textarea>
                    </div>
                    ...
                    <p style="font-family:var(--font-aux);font-size:.62rem;color:var(--text-muted);margin-top:.9rem;line-height:1.6;letter-spacing:.04em">
                        * Campos obrigatórios. Lorem ipsum dolor sit amet consectetur adipiscing LGPD/OAB.
                    </p>
                </form>
            </div>
        </div>
